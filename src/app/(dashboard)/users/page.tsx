    ...
    <div className="space-y-10">
                          ...
                          <TableRow key={`${member.uid}-perms`} className="bg-orange-50/20">
                            <TableCell colSpan={5} className="px-8 py-6">
                              <div className="space-y-4">
                                ...
                                {member.role === "owner" && (
                                  <div className="flex items-center gap-3 p-4 rounded-2xl bg-orange-50 border border-orange-200 text-sm">
      ...
      <Dialog open={isInviteDialogOpen} onOpenChange={setIsInviteDialogOpen}>
        <DialogContent className="sm:max-w-[425px] rounded-[2.5rem] p-8">
          <DialogHeader>
            <DialogTitle className="text-2xl font-headline">Inviter un Membre</DialogTitle>
            <DialogDescription className="text-gray-500 font-medium">
              Envoyez une invitation par email pour rejoindre {boutique?.name}.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleInvite} className="grid gap-6 py-4">
            <div className="space-y-2">
              <Label className="font-bold ml-1">Adresse Email</Label>
              <Input
                type="email"
                value={inviteEmail}
            ...
            <div className="space-y-2">
              <Label className="font-bold ml-1">Rôle</Label>
            ...
            <Button
              ...
              className="sena-gradient text-white w-full rounded-2xl h-14 font-bold text-lg mt-4 shadow-lg shadow-orange-500/20"
            >
              {isInviting ? (
                <>
