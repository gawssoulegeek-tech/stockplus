      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            data-state={state}
            className={cn(
              "group flex min-h-screen w-full has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer flex-shrink-0 hidden md:block text-sidebar-foreground"
        data-state={state}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "pl-0 md:pl-[var(--sidebar-width)] peer-data-[state=collapsed]:md:pl-[var(--sidebar-width-icon)] peer-data-[collapsible=offcanvas]:md:pl-0",
        // Variant inset styles
